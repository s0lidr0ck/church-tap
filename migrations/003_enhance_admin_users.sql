...
ALTER TABLE admin_users ADD COLUMN permissions TEXT; -- JSON array of permissions
ALTER TABLE admin_users ADD COLUMN last_login_at DATETIME;
ALTER TABLE admin_users ADD COLUMN last_login_ip TEXT;
ALTER TABLE admin_users ADD COLUMN is_active BOOLEAN DEFAULT 1;
ALTER TABLE admin_users ADD COLUMN email_verified BOOLEAN DEFAULT 1;
ALTER TABLE admin_users ADD COLUMN invitation_token TEXT;
ALTER TABLE admin_users ADD COLUMN invitation_expires_at DATETIME;
...
CREATE INDEX idx_admin_users_organization_role ON admin_users(organization_id, role);
