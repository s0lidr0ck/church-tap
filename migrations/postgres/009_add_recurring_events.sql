...
-- 1. Parent events have is_recurring = TRUE and contain the recurrence rules
-- 2. Generated instances have is_instance = TRUE and parent_event_id pointing to the parent
-- 3. Both parent and instances can be edited independently 
-- 4. Deleting a parent can optionally delete all future instances
-- 5. Individual instances can be cancelled/modified without affecting the series
