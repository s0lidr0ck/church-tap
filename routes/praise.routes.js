...
router.post('/', authenticateUser, requireActiveGroupMembership, requireOrgFeature('praiseReports', { message: 'Praise Reports are disabled for this group' }), validateInput.communityContent, validateInput.sanitizeHtml, (req, res) => {
...
router.post('/celebrate', authenticateUser, requireActiveGroupMembership, requireOrgFeature('praiseReports', { message: 'Praise Reports are disabled for this group' }), (req, res) => {
